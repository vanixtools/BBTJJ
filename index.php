...
curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36"); 
...
$c = curl_init("https://login.yahoo.com/"); 
curl_setopt($c, CURLOPT_FOLLOWLOCATION, true); 
curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (iPad; CPU OS 11_0 like Mac OS X) AppleWebKit/604.1.34 (KHTML, like Gecko) Version/11.0 Mobile/15A5341f Safari/604.1"); 
...
function check_ban($gmail){
    ...
    $c = curl_init("https://accounts.google.com/signin/v2/identifier?continue=https://adssettings.google.com/authenticated?hl=ar&hl=ar&ec=GAlAmQM&flowName=GlifWebSignIn&flowEntry=AddSession"); 
    curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (iPad; CPU OS 11_0 like Mac OS X) AppleWebKit/604.1.34 (KHTML, like Gecko) Version/11.0 Mobile/15A5341f Safari/604.1"); 
    curl_setopt($c, CURLOPT_HTTPHEADER, $header); 
